...
<div class = "row">
    ...
    <div class = "col-md-3">
      <a href=" {{ route ('Order.CancelCreateaBouquet',['order_ID'=>$order_ID]) }} " class="btn btn-md btn-danger btn-tooltip" data-toggle="tooltip" data-placement="bottom" title="Upon clicking this button please be aware that everything you made here will now be saved for you have cancelled the creation, and will redirect you to your specific order" data-container="body"><span class = "glyphicon glyphicon-remove"></span> Cancel bouquet creation </a>
    </div>
</div><!--end of row-->
...
<div class = "row" style = "">
      ...
      {!! Form::open(array('route' => 'Orders_Bouquet.store', 'data-parsley-validate'=>'', 'files' => 'true', 'method'=>'POST')) !!}
                    <div class = "col-md-7">
        ...
        <!--Start of Adding Acessory div-->
                  ...
                  {!! Form::open(array('route' => 'Orders_BouquetAcessories.store', 'data-parsley-validate'=>'', 'files' => 'true', 'method'=>'POST')) !!}
                    <div class = "col-md-7">
                    ...
                    <div class = 'col-md-4'>
                      <div>
                        ...
                        <div hidden> <!--start of hidden input field-->
                          ...
                          <input type="text" class="form-control" name="AcessoryorderID_Field" id="AcessoryorderID_Field" value = "{{$order_ID}}"/>
        ...
        {!! Form::model($BQT_Flowers, ['route'=>['Orders_Bouquet.update', $BQT_Flowers->id],'method'=>'PUT'])!!} 
                    <div class="row">
                      ...
                      <div class="col-xs-8">
                        ...
                        <div class="col-md-2"  hidden>
                          <input id = 'ID_Field' name = 'ID_Field' class="form-control input-sm" value="{{$order_ID}}">
        ...
        {!! Form::close() !!}
                        <div class="col-xs-1">
                          <a type="button" href="{{ route('BqtFlowerorder.DelOrderFlowers',['flower_ID'=>$BQT_Flowers->id,'order_ID'=>$order_ID]) }}" class="btn btn-danger btn-xs">
        ...
        {!! Form::model($BQT_Acessories, ['route'=>['Orders_BouquetAcessories.update', $BQT_Acessories->id],'method'=>'PUT'])!!} 
...
<!--form close here for update-->
                        <div class="col-xs-1">
                          <a id = 'deleteAc_Btn' type="button" href="{{ route('BqtAcessoryorder.DelOrderAcessories',['Acessory_ID'=>$BQT_Acessories->id,'order_ID'=>$order_ID]) }}" class="btn btn-danger btn-xs">
                            <span class = "glyphicon glyphicon-trash"></span> 
                          </a>
                        </div>
                      </div>
                  ...
                  <div class="panel-footer">
                    <div class="row text-center">
                      ...
                      <div class="col-xs-3" style = "margin-left:-10%;">
                        <a id = "saveBtn" type="button" href = "{{ route('Bqtorder.saveBouquet',['order_ID'=>$order_ID]) }}" class="btn btn-info btn-md"  data-toggle="tooltip" data-placement="bottom" title="This Button will save the bouquet that you have created, also please be noted that if your flowers are less than 12 this button will not submit your Bouquet" data-container="body">
                          Add to my Order
                        </a>
                      </div>
                    </div>
