        ...
        <div class="col-md-6">
          ...
          <input id = "NewOrderDone_result" value = "{{$DoneOrderSession}}">
			...
			<div class="panel-footer">
				<h4 class="text-right" style = "color:red;"><b>Purchase Amount: {{number_format($invoice[10],2) }}</b></h4>
				<h4 class="text-right" style = "color:red;"><b>Delivery Charge: {{number_format($invoice[11],2) }}</b></h4>
				<h4 class="text-right" style = "color:red;"><b>Vat (12%): {{number_format($invoice[12],2) }}</b></h4>
				<h4 class="text-right" style = "color:red;"><b>Total Amount: {{number_format($invoice[15],2) }}</b></h4>
