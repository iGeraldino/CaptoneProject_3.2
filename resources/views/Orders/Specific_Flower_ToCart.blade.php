							...
							<div class="tab-pane active" id="Flowers">
							  @foreach($FlowerList as $Fdetails)
								<div class="col-sm-3" style="margin-bottom: 3%;">
									...
									<a class="btn btn-sm Lemon" data-toggle="modal" data-target="#flowerTab_modal{{$Fdetails->flower_ID}}"> QUICK VIEW</a>
	                    		</div>
									<!--MODAL FLOWER-->

									<!-- Modal Core -->
									<div class="modal fade" id="flowerTab_modal{{$Fdetails->flower_ID}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
										<div class="modal-dialog">
									    	<div class="modal-content">
									    		...
									    		<div class="modal-body">
									        		<div row>
									        			<div class="col-md-6">
									        				<img src="{{ asset('flowerimage/'.$Fdetails->IMG)}}" class="img-rounded img-responsive img-raised">
									        			</div>
									        			<div class="col-md-6 text-left">
											        		<h5>FLWR-{{$Fdetails->flower_ID}}</h5>
											        		<h5>{{$Fdetails->flower_name}}</h5>
											        		<div class="form-group">
  				                                            ...
  				                                            <div hidden> <!--start of hidden input field-->
					                                            <input type="number" class="form-control" name="OrigInputPrice_Field" id="OrigInputPrice_Field" step = '0.01' value = "{{$Fdetails->Final_SellingPrice}}"/>
								...
								<div class="col-md-6">
									...
									<div class="row">
										<div class="col-md-6" style="margin-bottom: 3%;">
											...
											<a class="btn btn-sm Lemon" data-toggle="modal" data-target="#flowermodal"> QUICK VIEW</a>
										</div>
										<div class="col-md-6" style="margin-bottom: 3%;">
											<img src="images/flower/pic3.jpg" alt="Raised Image" class="img-rounded img-responsive img-raised">
											<a class="btn btn-sm Lemon" data-toggle="modal" data-target="#flowermodal"> QUICK VIEW</a>
						...
						<div class="panel">
                    		...
                    		<div class="panel-body">
                    			...
                    			@foreach(Cart::instance('Ordered_Flowers')->content() as $Flwr)
			                        <div class="col-xs-1" style="margin-right: 2%"><img class="img-rounded img-raised img-responsive" style="min-width: 50px; max-height: 50px;" src="{{ asset('flowerimage/'.$Flwr->options['image'])}}">
			                        </div>
			                        <div class="col-xs-2">
