          ...
          <div class = "panel-body">
            ...
            @if($SalesOrder->Status == "BALANCED" OR $SalesOrder->Status == "A_P_PARTIAL" OR $SalesOrder->Status == "A_UNPAID")
              <div class="row">
                ...
                <div class = "col-md-6">
                  <a type = "button" class = "btn btn-md btn-success">Process Balance</a>
                </div>
              </div>
            @elseif($SalesOrder->Status  == "P_PARTIAL")
              <div class="row">
                ...
                <div class = "col-md-6">
                @if($SalesOrder->cust_Type == 'C')
                  <a id = "show_PaymentDiv" type = "button" data-toggle="tooltip"  data-placement="bottom" title="This button will show the paymet options that you could use to fulfill the balances of this order" class = "btn btn-md btn-success">Process Balance</a>
                @else
                  <a href = "" type = "button" class = "btn btn-md btn-success">Process Balance</a>
                @endif
                </div>
              </div>
